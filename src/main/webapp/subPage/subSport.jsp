...
<body style="background-color: rgba(224, 224, 224, 0.2);">
	...
	<div id="total">
		...
		<div id="total-right">
			...
			<div id="section">
				<a href="subSport.jsp?categoryName=Soccer"><img src="../icon/soccer.png" style="width: 60px;" alt="축구"></a>
				<a href="subSport.jsp?categoryName=BaseBall"><img src="../icon/baseball.png" style="width: 60px; margin-left: 10px;" alt="야구"></a>
				<a href="subSport.jsp?categoryName=BasketBall"><img src="../icon/basket.png" style="width: 60px; margin-left: 10px;" alt="농구"></a>
				<a href="subSport.jsp?categoryName=Golf"><img src="../icon/golf.png" style="width: 60px; margin-left: 10px;" alt="골프"></a>
				<a href="subSport.jsp?categoryName=SportETC"><img src="../icon/Cetc.png" style="width: 60px; margin-left: 10px;" alt="기타"></a>
			...
			<div id="footer">
				...
				<%
					 if(pageNumber != 1) {
				%>
					<a href="subSport.jsp?categoryName=<%= categoryName%>&pageNumber=<%= pageNumber - 1%>" class="btn btn-success btn-arrow-left" 

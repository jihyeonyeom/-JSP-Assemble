...
<body style="background-color: rgba(224, 224, 224, 0.2);">
	...
	<div class="container" style="margin-top: 100px;">
		<div class="row">
			...
			<thead>
				<tr>
					<th colspan="5" style="text-align: center; font-size: 20px;">파티원 목록</th>
				</tr>
			</thead>
			<tbody>
				<tr>
				...
				%>
					<td><a onclick="return confirm('추방하시겠습니까?')" href="partyDeportAction.jsp?partyNum=<%= partyNum%>&getUserID=<%= list.get(i).getUserID()%>" style="color: blue;">파티추방</a></td>
				<%
					} else {
				%>
					<td></td>
	...
	<div class="container" style="margin-top: 80px;">
		<div class="row">
			...
			<thead>
				<tr>
					<th colspan="3" style="text-align: center; font-size: 20px;">파티 가입신청 목록</th>
				</tr>
			</thead>
			<tbody>
			<%
			...
			<a href="view.jsp?partyNum=<%= partyNum%>" class="btn btn-primary" style="background-color: rgb(164, 214, 82); border-color: black; width: 90px; color: white">뒤로가기</a>
		</div>
	</div>

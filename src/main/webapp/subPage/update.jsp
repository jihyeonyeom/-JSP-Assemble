...
<body style="background-color: rgba(224, 224, 224, 0.2);">
	...
	<div class="container" style="margin-top: 50px;">
		<div class="row">
			<form method="post" action="updateAction.jsp?partyNum=<%= partyNum%>">
				<table class="table">
					<thead>
						<tr>
							<th colspan="2" style="text-align: center; font-size: 50px;"><%= bbs.getCategoryName()%> 글 수정</th>
						</tr>
					</thead>
					<tbody>
						<tr>
						...
						<tr>
							<td>오픈채팅 URL<input type="text" class="form-control" placeholder="오픈채팅 URL" name="bbsOpenChat" maxlength="50" value="<%= bbs.getBbsOpenChat()%>"></td>
						</tr>
					</tbody>
				</table>
				...
				<input type="submit" class="btn btn-primary pull-right" style="background-color: rgb(164, 214, 82); border-color: black; width: 90px; margin-left: 8px;" value="글 수정">
				<a href="javascript:window.history.back();" class="btn btn-primary pull-right" style="background-color: rgb(164, 214, 82); border-color: black; width: 90px; color: white">뒤로가기</a>
			</form>		
		</div>
	</div>

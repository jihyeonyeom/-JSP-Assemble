...
<body style="background-color: rgba(224, 224, 224, 0.2);">
	...
	<div id="total">
		<div id="nav"></div>
		<div id="total-right">
			<div id="section-blank"><h1 style="margin-left: 130px; margin-top: 50px;"><%= categoryName%></h1></div>
			<div id="section">
				<a href="subGame.jsp?categoryName=LOL"><img src="../icon/lol.png" style="width: 64px;" alt="리그오브레전드"></a>
				<a href="subGame.jsp?categoryName=BattleGrounds"><img src="../icon/pubg.png" style="width: 75px; margin-left: 6px;" alt="배틀그라운드"></a>
				<a href="subGame.jsp?categoryName=OverWatch"><img src="../icon/overwatch.png" style="width: 55px; margin-left: 10px;" alt="오버워치"></a>
				<a href="subGame.jsp?categoryName=SuddenAttack"><img src="../icon/sudden.png" style="width: 55px; margin-left: 20px;" alt="서든어택"></a>
				<a href="subGame.jsp?categoryName=GameETC"><img src="../icon/Cetc.png" style="width: 55px; margin-left: 20px;" alt="기타"></a>
			...
			<div id="footer">
				...
				<ul class="party" type="none">
					<li style="height: 100%;">
						<div class="top" style="cursor: pointer; color: red;" onclick="location.href='view.jsp?partyNum=<%= list.get(i).getPartyNum()%>';"><%= list.get(i).getCategoryName() %></div>
				...
				<%
					 if(pageNumber != 1) {
				%>
					<a href="subGame.jsp?categoryName=<%= categoryName%>&pageNumber=<%= pageNumber - 1%>" class="btn btn-success btn-arrow-left" 
